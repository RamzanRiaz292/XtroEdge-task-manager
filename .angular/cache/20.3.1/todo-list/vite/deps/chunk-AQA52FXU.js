...
__publicField(_EventManager, "ɵprov", ɵɵdefineInjectable({
  token: _EventManager,
...
__publicField(_SharedStylesHost, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_DomRendererFactory2, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_BrowserXhr, "ɵprov", ɵɵdefineInjectable({
  token: _BrowserXhr,
...
__publicField(_DomEventsPlugin, "ɵprov", ɵɵdefineInjectable({
...
var MODIFIER_KEY_GETTERS = {
  "alt": /* @__PURE__ */ __name((event) => event.altKey, "alt"),
  "control": /* @__PURE__ */ __name((event) => event.ctrlKey, "control"),
  "meta": /* @__PURE__ */ __name((event) => event.metaKey, "meta"),
  "shift": /* @__PURE__ */ __name((event) => event.shiftKey, "shift")
};
...
__publicField(_KeyEventsPlugin, "ɵprov", ɵɵdefineInjectable({
...
__name(createProvidersConfig, "createProvidersConfig");
function provideProtractorTestingSupport() {
  return [...TESTABILITY_PROVIDERS];
}
__name(provideProtractorTestingSupport, "provideProtractorTestingSupport");
function initDomAdapter() {
  BrowserDomAdapter.makeCurrent();
}
__name(initDomAdapter, "initDomAdapter");
...
__publicField(_BrowserModule, "ɵmod", ɵɵdefineNgModule({
  type: _BrowserModule,
  exports: [CommonModule, ApplicationModule]
}));
__publicField(_BrowserModule, "ɵinj", ɵɵdefineInjector({
...
__publicField(_Meta, "ɵprov", ɵɵdefineInjectable({
  token: _Meta,
  factory: _Meta.ɵfac,
  providedIn: "root"
}));
...
__publicField(_Title, "ɵprov", ɵɵdefineInjectable({
  token: _Title,
  factory: _Title.ɵfac,
  providedIn: "root"
}));
...
__name(exportNgVar, "exportNgVar");
var _ChangeDetectionPerfRecord = class _ChangeDetectionPerfRecord {
  msPerTick;
  numTicks;
...
__name(_ChangeDetectionPerfRecord, "ChangeDetectionPerfRecord");
var ChangeDetectionPerfRecord = _ChangeDetectionPerfRecord;
var _AngularProfiler = class _AngularProfiler {
  appRef;
  constructor(ref) {
...
__name(_AngularProfiler, "AngularProfiler");
var AngularProfiler = _AngularProfiler;
var PROFILER_GLOBAL_NAME = "profiler";
function enableDebugTools(ref) {
  exportNgVar(PROFILER_GLOBAL_NAME, new AngularProfiler(ref));
  return ref;
}
__name(enableDebugTools, "enableDebugTools");
function disableDebugTools() {
  exportNgVar(PROFILER_GLOBAL_NAME, null);
}
__name(disableDebugTools, "disableDebugTools");
var _By = class _By {
  /**
   * Match all nodes.
   *
...
__name(elementMatches, "elementMatches");
var EVENT_NAMES = {
  // pan
  "pan": true,
  "panstart": true,
...
__publicField(_HammerGestureConfig, "ɵprov", ɵɵdefineInjectable({
...
var _HammerGesturesPlugin = class _HammerGesturesPlugin extends EventManagerPlugin {
  ...
  addEventListener(element, eventName, handler) {
    ...
    if (!window.Hammer && this.loader) {
      ...
      let deregister = /* @__PURE__ */ __name(() => {
    ...
    return zone.runOutsideAngular(() => {
      ...
      const callback = /* @__PURE__ */ __name(function(eventObj) {
...
__publicField(_HammerGesturesPlugin, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_HammerModule, "ɵmod", ɵɵdefineNgModule({
  type: _HammerModule
}));
__publicField(_HammerModule, "ɵinj", ɵɵdefineInjector({
  providers: [{
    provide: EVENT_MANAGER_PLUGINS,
...
__publicField(_DomSanitizer, "ɵprov", ɵɵdefineInjectable({
  token: _DomSanitizer,
...
__publicField(_DomSanitizerImpl, "ɵprov", ɵɵdefineInjectable({
...
__name(provideZoneJsCompatibilityDetector, "provideZoneJsCompatibilityDetector");
...
__name(provideEnabledBlockingInitialNavigationDetector, "provideEnabledBlockingInitialNavigationDetector");
...
__name(provideClientHydration, "provideClientHydration");
...
@angular/platform-browser/fesm2022/platform-browser.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-AQA52FXU.js.map
